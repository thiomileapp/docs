...
**ETA,** _Example from the picture above: ETA 07:20_ This ETA will show you the **estimated arrival time of the user to this task location,** the calculation is based on the Last Update location of the user and the travel time that they need to reach this task location from their latest location history.
