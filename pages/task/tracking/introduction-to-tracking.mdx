...
This is where you set up the Start Finish feature: 1. Toggle to activate / deactivate this features 2. How often the coordinate of the MileApp Field user will be recorded 3. The radius around the hub where the MileApp Field user could start to accessing their task 4. The radius around the hub where the MileApp Field user could Finish to stopped accessing their task and stopped the coordinate recording
