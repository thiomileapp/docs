...
The **Custom** option allows you to create a schedule with a specific interval. For example, if you need to schedule a recurring task for machine maintenance every 2 months, you can use the Custom option. <div align="center">
