...
Tip: If you want to use the "Update Data Source" automation type, make sure you have created a data source and mapped it into the flow configuration. Learn more details here: [Data Source](/pages/data-source/how-to-create-and-use-data-source)
