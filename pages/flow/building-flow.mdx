...
<div align="center">
  <img src="https://t3837933.p.clickup-attachments.com/t3837933/84d13558-01eb-4814-9092-c392de4fd521/image.png" alt="image" width="600" />
</div>
<p><em>Flow Menu Display</em></p>

Flow settings are managed within the Pages & Configuration tab. You can only create or edit flow settings through the web interface. To create a new flow, click the New Flow button (1). The information you configure in the flow settings may appear in the web app, the mobile app, or both, depending on the flow type.
...
- Field Canvassing:
- Home Cleaning:
- House Inspection We advise first-time users to explore the ready-to-use flows or flow templates before creating one from scratch.

**Building a flow using template** <div align="center">
  <img src="https://t3837933.p.clickup-attachments.com/t3837933/d5f1198a-887f-4d7b-9bb1-ee22818ca46d/image.png" alt="image" width="600" />
</div>
<p><em>Flow Menu Display</em></p>

<div align="center">
  <img src="https://t3837933.p.clickup-attachments.com/t3837933/bd6033d9-cb48-4fb6-81c1-8b9e6230e8d6/image.png" alt="image" width="600" />
</div>
<p><em>Flow Use Template Display</em></p>
