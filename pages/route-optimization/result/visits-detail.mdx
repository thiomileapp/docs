...
<p><em>History Icon in List View</em></p>
...
<p><em>History Icon in Gantt Chart View</em></p>
...
-   **Source**: The way a visit has been moved, such as via individual move, bulk move, or vehicle switch. The most recent update will appear at the top of the list with indicator "_Current History_".
...
4. A loading indicator will appear to show that the data is being updated. The system will update the task data. However, **no changes** will be made to the routing result, and no recalculation or re-optimization will occur.
