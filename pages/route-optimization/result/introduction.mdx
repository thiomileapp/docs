...
3. **Action**:
   ...
   2. **Dispatch**: To assign the routing result to field users, you can click the Dispatch button. After dispatching, you can track assignments in the Task menu. Learn more [here](/pages/route-optimization/dispatch).
...
**Note**: When you click "Restore" on the current version, it will not add another entry to the history, and the result will remain unchanged. Restoration only reverts the routing to a specific previous change.

For example, if you have two history entries:
