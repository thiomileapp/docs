...
On the Visit page, you will see a list of active tasks. Active tasks are those with a status of either Ongoing or Unassigned. These tasks are ready for routing optimization, but you can still update some information related to the optimization. <div align="center">
  <img src="https://t3837933.p.clickup-attachments.com/t3837933/509c4f15-33a5-465a-a7f6-0d93825c8b24/image.png" alt="image" width="600" />
...
6. **Coordinate Validation Indicator**: Ensure the pin icon is green. If it is not, it means our system failed to geocode the coordinates or they are in an incorrect format. To fix this: \*   Input the coordinates manually using this format: latitude,longitude. \*   Adjust the address to a more readable format to help our system geocode it successfully.
