...
You will find two new inputs: **Grouped Visit** and **Priority**: <div align="center">
  <img src="https://t3837933.p.clickup-attachments.com/t3837933/39e642b7-b0c4-4f3b-b14b-95d9a380db5e/image.png" alt="image" width="600" />
</div> 1. **Visit Group**: This field allows you to assign visits to specific groups and ensure the same group is assigned to the same vehicle. Leave it empty if you want the routing to ignore visit grouping. 2. **Priority**: Specify the priority of visits within a group. The default priority is set to 0, with a range from 0 to 100. **A lower number indicates a higher priority**. In the **Routing/Result** menu, visit group information is displayed similarly to visit tags but highlighted in red and positioned below the visit tags.
