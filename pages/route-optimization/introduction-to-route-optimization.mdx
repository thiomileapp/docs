...
> Note: You can create more capacity constraint definitions, but each hub can only select up to 10 constraints.\
> The list of available constraints is the same across all hubs in your organization, but each hub can choose which constraints to actually use.
...
> Note: If Auto Speed is enabled, the per-vehicle speed field will be disabled.
...
> Note: This option is automatically enabled when **Multi Trip** is turned on.
...
Read more [here](https://doc.clickup.com/3837933/p/h/3n3zd-81962/aa00834626ae24f/3n3zd-231736) for details.
...
Read more [here](https://doc.clickup.com/3837933/p/h/3n3zd-81962/aa00834626ae24f/3n3zd-245116).
