...
1. **New Vehicle Button**: Click this button to add a new vehicle. A dialog box will appear, prompting you to enter the necessary details for the vehicle. Refer to [this](/pages/route-optimization/vehicle/how-to-create-a-vehicle) section for more detail about create new vehicle.
