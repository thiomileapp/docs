...
1. **View Custom Export**: This permission allows users to view a list of created custom exports when clicking "New" button in the Data Export submenu. For more details, read more about the Data Export feature [here](/pages/task/managing-task/export-to-excel).
