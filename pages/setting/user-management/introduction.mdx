...
</div> _List of users within the selected hub_ You can utilize the search input to find users across the organization. The suggestion results will include hub information along with the user. Click on the one you need. When you filter by role and team, the suggested results will be adjusted accordingly. <div align="center">
...
</div> _Suggestion results from the search input_
...
</div> _"Re-send Invitation" button_
...
</div> _Modifying the user's name_
...
</div> _Access the "Profile" option._

You can also add the user's phone number. Once it is saved, a WhatsApp icon will appear next to the phone number, allowing you to chat directly via WhatsApp. <div align="center">
...
</div> _Hub selection for a specific user_
...
</div> _The hub filter is located in the top right corner of the Task page._
...
</div> _Team selection for a specific user_
...
</div> _Role selection for a specific user_
...
- **Toggle OFF (Inactive)**: The user will be deactivated and unable to log in to either web or mobile applications. <div align="center">
