...
<img src="https://t3837933.p.clickup-attachments.com/t3837933/c93ffb62-85e3-4018-bd08-018f6cefe8f7/image.png" alt={true} /> [**Task Menu**](https://web.mile.app/tasks/task) is a central place for you to manage tasks, add a new task, import bulk tasks, assign tasks to a field user, check the status of each task, view details of each task, and export task reports. You could also monitor ongoing tasks and create a scheduled task from this menu.