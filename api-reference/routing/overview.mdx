...
<CardGroup cols={2}>
  <Card title="Vehicle" icon="truck" href="/api-reference/routing/vehicle-overview">
    Manage vehicles for route optimization
  </Card>
  <Card title="Routing" icon="route" href="/api-reference/routing/overview">
...
To see the details of routing object, please follow [this link](/api-reference/objects/routing-object).

## Related Resources

- [Task](/api-reference/task/overview) - Tasks can serve as visits in route optimization
- [Vehicle Object](/api-reference/objects/vehicle-object) - Vehicle data structure
- [Routing Object](/api-reference/objects/routing-object) - Routing result data structure
