...
<CardGroup cols={2}>
  <Card title="List Tasks" icon="list" href="/api-reference/task/task/read-tasks">
    Retrieve all tasks with filtering options
  </Card>
  <Card title="Create Task" icon="plus" href="/api-reference/task/task/create-task">
    Create a new task
  </Card>
  <Card title="Update Task" icon="pen" href="/api-reference/task/task/update-task-by-id">
    Update an existing task
  </Card>
  <Card title="Assign Task" icon="user-plus" href="/api-reference/task/task/assign-task-by-id">
...
- [Location History](/api-reference/task/location-history-overview) - Track task execution locations
- [Task Schedule](/api-reference/task/task-schedule-overview) - Create recurring tasks
