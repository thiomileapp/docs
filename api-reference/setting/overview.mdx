...
<CardGroup cols={2}>
  <Card title="List Users" icon="users" href="/api-reference/setting/user/read-user">
    Retrieve all users in your organization
  </Card>
  <Card title="Invite User" icon="user-plus" href="/api-reference/setting/user/read-user-by-email">
...
<CardGroup cols={2}>
  <Card title="List Hubs" icon="warehouse" href="/api-reference/setting/hub/read-hub">
...
<CardGroup cols={2}>
  <Card title="User Management" icon="users" href="/api-reference/setting/user/read-user">
    Manage organization users
  </Card>
  <Card title="Role Management" icon="shield" href="/api-reference/setting/role/read-role">
    Configure roles and permissions
  </Card>
  <Card title="Hub Management" icon="warehouse" href="/api-reference/setting/hub/read-hub">
    Manage hub locations
  </Card>
  <Card title="Team Management" icon="people-group" href="/api-reference/setting/team/read-team">
